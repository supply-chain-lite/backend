...
set_project_status_null = "UPDATE S_Projects SET ProjectStatus=NULL WHERE UserEmail=?; "

set_project_status_active = "UPDATE S_Projects SET ProjectStatus='Active' WHERE UserEmail=? AND ProjectName=?"
